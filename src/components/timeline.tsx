      ...
      <div className="relative w-full h-20 cursor-pointer" onClick={handleTimelineClick}>
        ...
        {selectedTime && (
          ...
          >
            ...
            <div className="absolute -translate-x-1/2 top-7 h-3 w-3 rounded-full bg-blue-500 border-2 border-white"></div>
          </div>
        )}
          ...
          >
            {marker.value && (
              <div className="absolute bottom-4 mb-1 -translate-x-1/2 left-1/2">
                <div className="bg-red-200 px-1 py-0.5 rounded text-xs font-medium">{marker.value}</div>
              </div>
            )}
            <div className="h-2 w-2 rounded-full bg-red-500 mt-[29px]"></div>
          </div>
        ))}
